...
public class SimpleFileChooser {
	 ...
	 *                      If this name is null, then the user's home directory
	 *                      will be used.
	 */
	 ...
	 *                      name is null, then the user's home directory will be
	 *                      used.
	 */
	 ...
	 *                    the parent component becomes the parent window of the
	 *                    dialog box. This
	 *                    means that the window is "blocked" until the dialog is
	 *                    dismissed. Also,
	 *                    the dialog box's position on the screen should be based on
	 *                    the position of
	 *                    the window. Generally, you should pass your application's
	 *                    main window or
	 *                    panel as the value of this parameter.
	 * @param dialogTitle a title to be displayed in the title bar of the dialog
	 *                    box. If the value of this parameter is null, then the
	 *                    dialog title will
	 ...
	 *                    as the name of the selected file. If the value of this
	 *                    parameter is null,
