...
/**
 * A panel that can display a background image, a gradient over the image that
 * changes
 * from almost transparent at the top to almost opaque at the bottom, a
 * multiline text,
 * and a list of small images on top of everything else. The small images are
 * placed by
 * clicking with the mouse. The image that is placed is determined by the
 * currentDrawImage
 * property; if this property is null, then clicking an existing image with the
 * mouse will
 * remove that image.
 */
